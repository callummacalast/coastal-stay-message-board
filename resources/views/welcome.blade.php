<x-guest-layout>
    ...
    <div class="container mx-auto space-x-3 gap-3 lg:grid-cols-3 md:grid-cols-2 grid-cols-1 grid">
        @foreach ($messages as $message)
        <a href="/messages/{{$message->id}}">

            <div class="card shadow bg-white-300 p-2 rounded w-full h-full shadow m-3">
    ...
    <div class="pagination container mx-auto mt-5 p-3">
